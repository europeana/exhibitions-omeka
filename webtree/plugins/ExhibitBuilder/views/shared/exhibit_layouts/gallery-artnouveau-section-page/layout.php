...
//*************************************************************************************************************************
if (!$page) { $page = exhibit_builder_get_current_page(); }
...
<div class="grid_9" id="story">
            <div class="error">This layout is no longer used. Please use the 'Story' layout</div>
    <div id="exhibit-section-title"><h3><?php echo $theme . ' - ' . $story; ?></h3></div>
...
<div class="grid_6 flush" id="items">
    ...
    <div id="exhibit-item-thumbnails">
        <?php echo ws_exhibit_builder_display_exhibit_thumbnail_gallery(1, 5, array('class' => 'show')); ?>
    </div>
</div>
